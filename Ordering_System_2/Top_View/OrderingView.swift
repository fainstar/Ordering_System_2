...
struct OrderingView: View {
    ...
    var body: some View {
        VStack {
            ...
            // 新增結帳和取消按鈕
            HStack(spacing: 20) {
                NavigationLink(destination: OrderDetailView(orderDetail: viewModel.orderDetails(), totalPrice: viewModel.totalPrice(),customerName: userName,customerPhone: userPhone), isActive: $isOrderDetailViewActive) {
